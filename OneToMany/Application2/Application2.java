...
public Application2( String name,float version){
	this.name=name;
...
void displayDeveloperAddressSize()
	...
	void displayDeveloperCountryStateSize()
	{
		if(this.developer.addresses!=null)
		{
			...
			{
				Address2 address =developer.addresses[s];
	...
	void displayDeveloperAddressStreet()
	{
		if(this.developer.addresses!=null)
		{
			...
			{
				Address2 address = developer.addresses[r];
				String street = address.street;
	...
	void displayDeveloperCountry()
	{
		if(this.developer.addresses!=null)
		{
			...
			{
				Address2 address= developer.addresses[f];
				Country2 country = address.country;
