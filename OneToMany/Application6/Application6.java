...
public Application6( String name,float version){
	this.name=name;
...
void displayDeveloperAddressSize()
	...
	void displayDeveloperCountryStateSize()
	{
		if(this.developer.addresses!=null)
		{
			...
			{
				Address6 address =developer.addresses[s];
	...
	void displayDeveloperAddressStreet()
	{
		if(this.developer.addresses!=null)
		{
			...
			{
				Address6 address = developer.addresses[r];
				String street = address.street;
	...
	void displayDeveloperCountry()
	{
		if(this.developer.addresses!=null)
		{
			...
			{
				Address6 address= developer.addresses[f];
				Country6 country = address.country;
