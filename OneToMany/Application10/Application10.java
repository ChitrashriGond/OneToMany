...
public Application10( String name,float version){
	this.name=name;
...
void displayDeveloperAddressSize()
	...
	void displayDeveloperCountryStateSize()
	{
		if(this.developer.addresses!=null)
		{
			...
			{
				Address10 address =developer.addresses[s];
	...
	void displayDeveloperAddressStreet()
	{
		if(this.developer.addresses!=null)
		{
			...
			{
				Address10 address = developer.addresses[r];
				String street = address.street;
	...
	void displayDeveloperCountry()
	{
		if(this.developer.addresses!=null)
		{
			...
			{
				Address10 address= developer.addresses[f];
				Country10 country = address.country;
	...
	void displayDeveloperCityName()
	{
		if(this.developer.addresses!=null)
		{
			...
			{
				Address10 address = developer.addresses[j];
				Country10 country = address.country;
				State10[] states = country.states;
				for(int index=0; index<states.length; index++)	
				{ 
					State10 state =states[index];
